          ...
          >
            {messages.map((msg) => (
              ...
              >
                ...
                >
                  <span className="mb-1 block type-label text-amber-500/70">
                  ...
                  {DATE_NIGHT_SCENARIOS.map((scenario) => (
                    ...
                    >
                      ...
                      <div className="relative z-10 p-3">
                        <h3 className="font-serif type-section-heading text-luxury-primary sm:text-base">
                          {scenario.title}
                        </h3>
      ...
      <AnimatePresence>
        {showInvite && selected ? (
          ...
          >
            ...
            >
              <p className="type-label text-amber-500/85">
                Surprise Mode
              </p>
              <h2
                id="surprise-invite-title"
                className="mt-1 type-card-title text-luxury-primary sm:text-2xl"
              >
              ...
              <form onSubmit={(e) => void handleInviteSubmit(e)} className="mt-4 space-y-3">
                ...
                <div className="flex gap-2 pt-1">
                  <button
                    ...
                    className="flex-1 rounded-full border border-stone-700/80 py-2.5 type-section-heading text-stone-300 transition hover:border-stone-600"
                  >
                    Back
                  </button>
                  <button
                    type="submit"
                    disabled={submitting}
                    className="flex-1 rounded-full border border-amber-400/55 bg-gradient-to-b from-amber-200/95 to-amber-600 py-2.5 text-sm font-medium text-zinc-950 transition hover:from-amber-100 hover:to-amber-500 disabled:opacity-60"
                  >
