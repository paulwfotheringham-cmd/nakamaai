  ...
  return (
    <div className="h-full rounded-3xl border border-white/10 bg-white/5 p-6 transition-all duration-200 hover:border-white/20 hover:bg-white/10">
      ...
      <div className="mt-6 flex items-center gap-3 flex-wrap">
        ...
        <Link
          href="/create-audio"
          className="inline-flex items-center gap-1.5 rounded-xl border border-white/10 bg-white/8 px-4 py-2 type-section-heading text-luxury-primary transition hover:bg-white/15"
