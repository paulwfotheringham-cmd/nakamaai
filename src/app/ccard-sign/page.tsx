...
export default function CcardSignPage() {
  ...
  return (
    <main className="min-h-screen bg-[#07040d] text-white">
      <section className="mx-auto max-w-6xl px-6 py-16 sm:px-8 lg:px-10">
        <div className="mb-10">
          <p className="text-sm font-medium text-zinc-400">Nakama Nights subscription</p>
          <h1 className="mt-2 text-4xl font-semibold tracking-tight sm:text-5xl">
            Complete your subscription
          </h1>
          <p className="mt-4 max-w-2xl text-base leading-7 text-zinc-300">
            Fake checkout for development and testing only. No real payment will be
            taken — use any test card details.
          </p>
        </div>
